...
than a browser with flash-plugin. Here are some:

[Keybr.com][keybr]: Semi-random text, different difficulty levels, language
settings, own texts, websites and graphical over-time-comparison.

[Typeracer][typeracer]: Competitive typing of texts from popular movies and
books.

[typing.io][typingio]: Special typing training for code, lots of examples for
every popular languages.

  [keybr]: http://keybr.com "Keybr"
  [typeracer]: http://play.typeracer.com/ "Typeracer"
  [typingio]: http://typing.io/ "typing.io"
