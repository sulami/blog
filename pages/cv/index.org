...
#+LATEX_HEADER: \usepackage[margin=15mm, voffset=-10mm, bmargin=0mm]{geometry}
...
I am active in the open source community. Please see [[https://github.com/sulami][GitHub (sulami)]]
for my current projects.@@html:<!--@@ \newline @@html:-->@@

I have also contributed to various open source projects, including the
Linux kernel, the Rust compiler, and the Clojure language, as well as
