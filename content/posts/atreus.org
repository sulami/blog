...
has worked out fairly well. Chrysalis is a React Native app, and doing
...
new version onto the keyboard only takes a few seconds. I also have
to mention the [[https://kaleidoscope.readthedocs.io/en/latest/][extensive documentation]] available. Kaleidoscope has a
rich plugin infrastructure, very little of which I actually use, but
it does seem to rival QMK in flexibility.
