...
Slug: streaming-to-twitch-tv-using-ffmpeg-and-alsa
...
You get your stream key [here][]. Adjust resolutions as needed (input
...
of CPU cores you want to use to encode.
  ...
  [here]: http://www.twitch.tv/broadcast "Twitch"
